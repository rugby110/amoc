...
%%
%%==============================================================================
-module(mongoose_pubsub_twonodes).
...
start(MyId) ->
    ...
    Cfg = case is_listener_selector(MyId) of
              true -> pubsub_utils:make_user_for_node(MyId, Res, element(1,?SERVER_IPS));
              false -> pubsub_utils:make_user_for_node(MyId, Res, element(2,?SERVER_IPS))
          end,
